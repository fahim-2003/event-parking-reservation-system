        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Venues_Capacity_Positive", "[Capacity] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Events_EndAfterStart", "[EndDateTimeUtc] > [StartDateTimeUtc]");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ParkingSlots_SlotNumber_Positive", "[SlotNumber] > 0");
                    table.CheckConstraint("CK_ParkingSlots_Status_Valid", "[Status] IN ('Available', 'Held', 'Occupied')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Seats_SeatNumber_Positive", "[SeatNumber] > 0");
                    table.CheckConstraint("CK_Seats_Status_Valid", "[Status] IN ('Available', 'Held', 'Booked')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bookings_Status_Valid", "[Status] IN ('Held', 'Confirmed', 'Cancelled', 'Expired')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CustomerId_EventId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingSlots_EventId_Zone_SlotNumber",
                table: "ParkingSlots",
                columns: new[] { "EventId", "Zone", "SlotNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_EventId_DisplayLabel",
                table: "Seats",
                columns: new[] { "EventId", "DisplayLabel" },
                unique: true);
